...
<%@page import="Johnny.RhinoDataFix.Beans.Product"%>
<%@page import="Johnny.RhinoDataFix.Dao.ProductDao"%>
...
<div class="container">
  ...
  <form class="form-horizontal" action="/RhinoDataFix/productedit.jsp?id=${id}" method="Post">
